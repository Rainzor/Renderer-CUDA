...
IF(${COMPUTES_LEN} EQUAL 0 AND ${FALLBACK})
    ...
    LIST(APPEND COMPUTES_DETECTED_LIST "50" "60" "70" "80")
    MESSAGE(STATUS "No computes detected. Fall back to 50, 60, 70, 80")
ENDIF()
...
FOREACH(VER 50 52 53 60 61 62 70 72 75 80 86)
